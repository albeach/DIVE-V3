...
test.describe('IdP Management - Admin Features (Refactored)', { tag: '@smoke' }, () => {
    ...
    test('Admin can navigate to IdP management page', async ({ page }) => {
        await test.step('Navigate to admin IdP page', async () => {
            await page.goto('/admin/idp', {
                timeout: TEST_CONFIG.TIMEOUTS.NAVIGATION,
            });
        });

        await test.step('Verify IdP management page loaded', async () => {
        ...
        await test.step('Verify stats bar or summary visible', async () => {
    ...
    test('Admin can view IdP list', async ({ page }) => {
        ...
        await test.step('Verify at least one IdP card visible', async () => {
        ...
        await test.step('Verify multiple IdPs listed', async () => {
    ...
    test('Admin can navigate to analytics page', async ({ page }) => {
        await test.step('Navigate to admin analytics', async () => {
    ...
    test('Admin can navigate to logs page', async ({ page }) => {
        await test.step('Navigate to admin logs', async () => {
    ...
    test('Admin can navigate to approvals page', async ({ page }) => {
        await test.step('Navigate to admin approvals', async () => {
            await page.goto('/admin/approvals', {
                timeout: TEST_CONFIG.TIMEOUTS.NAVIGATION,
            });
        });

        await test.step('Verify approvals page loaded', async () => {
    ...
    test('Admin navigation links work correctly', async ({ page }) => {
        ...
        await test.step('Verify admin navigation menu exists', async () => {
    ...
    test('Admin can view dashboard with metrics', async ({ page }) => {
        ...
        await test.step('Verify dashboard loaded with metrics', async () => {
...
test.describe('IdP Management - Create/Update Operations (Refactored)', () => {
    ...
    test('Admin can navigate to create new IdP page', async ({ page }) => {
        ...
        await test.step('Click create/add new IdP button', async () => {
        ...
        await test.step('Verify new IdP form/page loaded', async () => {
    ...
    test('New IdP page loads with form fields', async ({ page }) => {
        await test.step('Navigate directly to new IdP page', async () => {
        ...
        await test.step('Verify protocol selection available', async () => {
            // OIDC/SAML selection
...
test.describe('IdP Management - SP Registry (Refactored)', () => {
    ...
    test('Admin can navigate to SP registry', async ({ page }) => {
        await test.step('Navigate to SP registry page', async () => {
            await page.goto('/admin/sp-registry', {
                timeout: TEST_CONFIG.TIMEOUTS.NAVIGATION,
            });
        });

        await test.step('Verify SP registry page loaded', async () => {
    ...
    test('SP registry shows list of service providers', async ({ page }) => {
        await test.step('Navigate to SP registry', async () => {
            await page.goto('/admin/sp-registry', {
                timeout: TEST_CONFIG.TIMEOUTS.NAVIGATION,
            });
        });

        await test.step('Verify SP list or table visible', async () => {
