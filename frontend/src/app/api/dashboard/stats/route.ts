 ...
 * 
 * Proxy for authenticated dashboard statistics endpoint
 * Returns user-specific stats including top deny reasons and decisions by country
 */
...
export async function GET(request: NextRequest): Promise<NextResponse> {
    try {
        ...
        if (!response.ok) {
            ...
            console.error('[DashboardStatsAPI] Backend error:', {
