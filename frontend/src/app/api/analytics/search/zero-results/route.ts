...
export async function GET(request: NextRequest): Promise<NextResponse> {
    try {
        ...
        const response = await fetch(`${BACKEND_URL}/api/analytics/search/zero-results?limit=${limit}&days=${days}`, {
            method: 'GET',
            headers: {
        ...
        if (!response.ok) {
            ...
            console.error('[ZeroResultsAPI] Backend error:', {
        ...
        console.error('[ZeroResultsAPI] Error:', error);
