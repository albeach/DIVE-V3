/**
 * Admin IdP MFA Config Test API Route
 * 
 * Proxy for backend IdP MFA test endpoint
 * POST - Test MFA flow for IdP
 */
...
export async function POST(
    ...
    try {
        ...
        const response = await fetch(`${BACKEND_URL}/api/admin/idps/${alias}/mfa-config/test`, {
            method: 'POST',
            headers: {
        ...
        console.error('[AdminIdPMFATestAPI] Error:', error);
        return NextResponse.json(
