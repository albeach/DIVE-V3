#!/usr/bin/env bash
# =============================================================================
# DIVE V3 CLI - Spoke Secrets (Generation, Validation & Sync)
# =============================================================================
# Extracted from spoke-secrets.sh (Phase 13d)
# Contains: generate, validate, sync, keycloak client sync, federation sync,
#   test accessibility, report
# =============================================================================

[ -n "${SPOKE_SECRETS_SYNC_LOADED:-}" ] && return 0
...
export SPOKE_SECRETS_SYNC_LOADED=1
