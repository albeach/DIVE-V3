...
cmd_help() {
    ...
    echo "  spoke seed <CODE> [count]    Seed users/resources (opt-in, post-federation)"
    ...
    echo "  ./dive spoke federate ALB --auth-code <UUID>"
    echo "  ./dive spoke federate ALB --auth-code <UUID> --seed --seed-count 5000"
    echo ""
