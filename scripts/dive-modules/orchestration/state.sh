...
declare -gA VALID_TRANSITIONS=(
    ...
    [FAILED]="INITIALIZING,DEPLOYING,CONFIGURING,VERIFYING,COMPLETE,CLEANUP,ROLLING_BACK"
...
# Load state query functions
source "$(dirname "${BASH_SOURCE[0]}")/state-queries.sh"
