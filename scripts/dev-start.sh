...
echo ""
echo -e "${BLUE}👤 Test Users (testuser-{country}-{level}):${NC}"
echo "  testuser-usa-1  TestUser2025!Pilot  (UNCLASSIFIED)"
echo "  testuser-usa-2  TestUser2025!Pilot  (CONFIDENTIAL)"
echo "  testuser-usa-3  TestUser2025!Pilot  (SECRET)"
echo "  testuser-usa-4  TestUser2025!Pilot  (TOP_SECRET)"
echo ""
