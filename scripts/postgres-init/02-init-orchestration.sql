...
--
-- Deployment: Automatically run during Hub PostgreSQL initialization
-- Rollback: See 001_orchestration_state_db.rollback.sql
-- ============================================================================

-- Database is created by init-db.sh, we just need to use it
-- \c orchestration is handled by the calling script
