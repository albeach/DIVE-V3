...
echo "🔐 Generating Test RSA Keys for E2E Testing"
echo "============================================"
echo ""
...
echo ""
echo "✅ Test RSA keys generated successfully!"
echo ""
echo "📂 Key Locations:"
echo "   Private: $KEYS_DIR/test-private-key.pem"
echo "   Public:  $KEYS_DIR/test-public-key.pem"
echo ""
echo "🔒 Private key permissions: 600 (read/write owner only)"
echo "📖 Public key permissions:  644 (readable by all)"
echo ""
echo "⚠️  IMPORTANT:"
