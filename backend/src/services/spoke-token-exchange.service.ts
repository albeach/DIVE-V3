...
const INSTANCE_REGISTRY: Record<string, IInstanceInfo> = {
    USA: {
        ...
        tokenIntrospectionUrl: process.env.USA_INTROSPECTION_URL || 'https://usa-idp.dive25.com/realms/dive-v3-broker-usa/protocol/openid-connect/token/introspect',
        jwksUrl: process.env.USA_JWKS_URL || 'https://usa-idp.dive25.com/realms/dive-v3-broker-usa/protocol/openid-connect/certs',
        trustLevel: 'high',
        country: 'USA',
        enabled: true,
    },
    FRA: {
        ...
        tokenIntrospectionUrl: process.env.FRA_INTROSPECTION_URL || 'https://fra-idp.dive25.com/realms/dive-v3-broker-usa/protocol/openid-connect/token/introspect',
        jwksUrl: process.env.FRA_JWKS_URL || 'https://fra-idp.dive25.com/realms/dive-v3-broker-usa/protocol/openid-connect/certs',
        trustLevel: 'high',
        country: 'FRA',
        enabled: true,
    },
    GBR: {
        ...
        tokenIntrospectionUrl: process.env.GBR_INTROSPECTION_URL || 'https://gbr-idp.dive25.com/realms/dive-v3-broker-usa/protocol/openid-connect/token/introspect',
        jwksUrl: process.env.GBR_JWKS_URL || 'https://gbr-idp.dive25.com/realms/dive-v3-broker-usa/protocol/openid-connect/certs',
        trustLevel: 'high',
        country: 'GBR',
        enabled: true,
    },
    DEU: {
        ...
        tokenIntrospectionUrl: process.env.DEU_INTROSPECTION_URL || 'https://deu-idp.dive25.com/realms/dive-v3-broker-usa/protocol/openid-connect/token/introspect',
        jwksUrl: process.env.DEU_JWKS_URL || 'https://deu-idp.dive25.com/realms/dive-v3-broker-usa/protocol/openid-connect/certs',
        trustLevel: 'high',
        country: 'DEU',
        enabled: true,
    },
