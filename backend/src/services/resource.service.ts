 ...
 */
export async function getResourceById(resourceId: string, authHeader?: string): Promise<IZTDFResource | null> {
    try {
        // Detect cross-instance resource by prefix: doc-{INSTANCE}-seed-...
