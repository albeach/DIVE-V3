/**
 * Deployment: COI SSOT Validation
 *
 * Requires live deployment with seeded COI definitions (22 total).
 * Skipped during unit tests (SKIP_INTEGRATION_TESTS=true).
 * Run manually: SKIP_INTEGRATION_TESTS=false npx jest deployment/coi-validation
 */
...
if (SKIP) {
  describe('Deployment: COI SSOT Validation', () => {
    it('skipped — requires live deployment with seeded COI data', () => {
