 ...
 *
 * Requires live MongoDB replica set and PostgreSQL instance.
 * Validates replica set status, change stream support, audit tables,
 * and required databases.
 * Skipped during unit tests (SKIP_INTEGRATION_TESTS=true).
 * Run manually: SKIP_INTEGRATION_TESTS=false npx jest deployment/infrastructure
 */
