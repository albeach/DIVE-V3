...
// Try dive-v3-client-broker first, fallback to dive-v3-client
// NOTE: Environment variable CLIENT_ID might be set to 'dive-v3-client' - we'll try both
const CLIENT_ID = process.env.KEYCLOAK_CLIENT_ID || process.env.CLIENT_ID || 'dive-v3-client-broker';
const FALLBACK_CLIENT_ID = CLIENT_ID === 'dive-v3-client-broker' ? 'dive-v3-client' : 'dive-v3-client-broker';
