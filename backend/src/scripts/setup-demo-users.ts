...
async function setupInstance(instance: string): Promise<void> {
    ...
    try {
        ...
        console.log(`\n✅ Instance ${instance} setup complete!`);

    } catch (error: any) {
        console.error(`\n❌ ERROR setting up instance ${instance}:`, error.message);
...
async function printCredentialsList(): Promise<void> {
    ...
    console.log(`\n\n📝 NOTES:`);
    console.log('  • OTP codes are pre-configured with secret: DEMO123456789012345678901234567890');
    console.log('  • For demo purposes, use code: 123456');
    console.log('  • Super admin users have super_admin role for /admin/dashboard access');
    console.log('  • UNCLASSIFIED users (level 1) do not require MFA');
    console.log('  • TOP_SECRET users (level 4) require WebAuthn (passkey)');
    console.log('  • SECRET/CONFIDENTIAL users (levels 2-3) require OTP');
    console.log('\n');
}

async function main() {
    console.log('\n╔════════════════════════════════════════════════════════════════╗');
    console.log('║     DIVE V3 - Demo Users Setup for Presentation                ║');
    console.log('╚════════════════════════════════════════════════════════════════╝\n');
    ...
    console.log('✅ Setup complete! Users are ready for demo.\n');
}
