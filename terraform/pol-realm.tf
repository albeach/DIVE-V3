...
resource "keycloak_openid_client" "pol_realm_client" {
  ...
  valid_redirect_uris = [
    "https://localhost:8443/realms/dive-v3-broker/broker/pol-realm-broker/endpoint",
    "https://keycloak:8443/realms/dive-v3-broker/broker/pol-realm-broker/endpoint"
  ]
