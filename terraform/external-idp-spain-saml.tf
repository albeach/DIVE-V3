...
module "spain_saml_idp" {
  ...
  # SAML Configuration
  idp_entity_id = "https://spain-saml:9443/simplesaml/saml2/idp/metadata.php"
  idp_sso_url   = "https://spain-saml:9443/simplesaml/saml2/idp/SSOService.php"
  idp_slo_url   = "https://spain-saml:9443/simplesaml/saml2/idp/SingleLogoutService.php"
