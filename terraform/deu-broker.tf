...
resource "keycloak_oidc_identity_provider" "deu_realm_broker" {
  ...
  token_url         = "http://localhost:8081/realms/dive-v3-deu/protocol/openid-connect/token"
  jwks_url          = "http://localhost:8081/realms/dive-v3-deu/protocol/openid-connect/certs"
  user_info_url     = "http://localhost:8081/realms/dive-v3-deu/protocol/openid-connect/userinfo"
