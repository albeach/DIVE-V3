...
resource "keycloak_oidc_identity_provider" "fra_realm_broker" {
  ...
  jwks_url          = "http://localhost:8081/realms/dive-v3-fra/protocol/openid-connect/certs"
  user_info_url     = "http://localhost:8081/realms/dive-v3-fra/protocol/openid-connect/userinfo"
