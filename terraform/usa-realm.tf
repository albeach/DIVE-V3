...
resource "keycloak_realm" "dive_v3_usa" {
  ...
  # ACR to LOA Mapping (Authentication Context Class Reference to Level of Assurance)
  # Maps authentication flows to NIST AAL levels
  # Format: Map<String, Integer> - ACR level to LOA integer
  # "0" = 0 (AAL1: password only)
  # "1" = 1 (AAL2: password + OTP/SMS)
  # "2" = 2 (AAL3: password + WebAuthn/hardware key)
  attributes = {
...
resource "keycloak_openid_client" "usa_realm_client" {
  ...
  valid_redirect_uris = [
    "${var.keycloak_public_url}/realms/dive-v3-broker/broker/usa-realm-broker/endpoint",
